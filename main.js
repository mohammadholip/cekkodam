function cekKhodam() {
  ...
  document.getElementById("loading").style.display = "block"; // spinner
  setTimeout(() => {
    const khodams = [
      {
        name: "peller",
      ...
      { name: "babi", meaning: " mukamu seperti babi hook2" },
      { name: "beautiful", meaning: "Selalu cantik saat diletakkan di meja" },
      {
        name: " muka babi",
        meaning: "Tak pernah bisa diam dan selalu tertawa-tawa",
      },
      ...
      {
        name: "tidur anjing",
        meaning: "Terlihat ngantuk tapi selalu memberikan gigitan yang hangat",
      },
      {
        name: "Anjing Pelacak",
        meaning:
